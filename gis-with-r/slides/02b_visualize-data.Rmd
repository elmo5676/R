...
.class-info[
<figure>
  <img src="img/02b/ggplot-logo.png" alt="ggplot" title="ggplot" width="15%">
</figure>
]
...
background-image: url("img/02b/napoleon-retreat.jpg")
...
.center[
<figure>
  <img src="img/02b/napoleon-google-maps.png" alt="Moscow to Vilnius" title="Moscow to Vilnius" width="80%">
...
layout: false
class: bg-full
background-image: url("img/02b/minard.png")
...
<figure>
  <img src="img/02b/gg-book.jpg" alt="Grammar of Graphics book" title="Grammar of Graphics book" width="55%">
</figure>
...
.box-inv-1.medium.sp-after[It is impossible to cover everything ggplot can do in one short session!]

.box-1[[Free online asynchronous class dedicated to ggplot](https://datavizs21.classes.andrewheiss.com/)]


```{r echo=FALSE, include=FALSE, eval=FALSE}
pagedown::chrome_print(here::here("slides", "02b_visualize-data.html"), 
                       output = here::here("slides", "02b_visualize-data.pdf"))
```
