...
.class-info[
<figure>
  <img src="img/02a/RStudio.png" alt="RStudio" title="RStudio" width="15%">
</figure>
]
...
.pull-left.center[
<figure>
  <img src="img/02a/Rlogo.png" alt="R logo" title="R logo" width="80%">
</figure>
...
.pull-right.center[
<figure>
  <img src="img/02a/rstudio-logo.png" alt="RStudio logo" title="RStudio logo" width="100%">
</figure>
...
<figure>
  <img src="img/02a/rstudio-normal.png" alt="RStudio" title="RStudio" width="100%">
</figure>
...
.pull-left-wide[
<figure>
  <img src="img/02a/rstudio-console.png" alt="RStudio console" title="RStudio console" width="100%">
</figure>
]
...
.pull-left-wide[
<figure>
  <img src="img/02a/rstudio-files.png" alt="RStudio files panel" title="RStudio files panel" width="100%">
</figure>
]
...
.pull-left-wide[
<figure>
  <img src="img/02a/rstudio-files.png" alt="RStudio files pane" title="RStudio files pane" width="100%">
</figure>
]
...
<figure>
  <img src="img/02a/rstudio-editor.png" alt="RStudio source panel" title="RStudio source panel" width="80%">
</figure>
]
...
.pull-left.center[
<figure>
  <img src="img/02a/rstudio-rmd.png" alt="RStudio R Markdown document" title="RStudio R Markdown document" width="100%">
</figure>
]
...
.pull-left[
<figure>
  <img src="img/02a/rstudio-rmd-text.png" alt="RStudio R Markdown text" title="RStudio R Markdown text" width="100%">
</figure>
]
...
.pull-left[
<figure>
  <img src="img/02a/rstudio-rmd-code.png" alt="RStudio R Markdown code" title="RStudio R Markdown code" width="100%">
</figure>
]
...
.pull-left[
<figure>
  <img src="img/02a/rstudio-rmd-output.png" alt="RStudio R Markdown output" title="RStudio R Markdown output" width="100%">
</figure>
]
...
.center[
<figure>
  <img src="img/02a/rstudio-knit.png" alt="RStudio knit button" title="RStudio knit button" width="70%">
</figure>
]
...
.pull-left[
<figure>
  <img src="img/02a/rstudio-environment.png" alt="RStudio environment pane" title="RStudio environment pane" width="100%">
</figure>
]
...
.pull-left[
<figure>
  <img src="img/02a/rstudio-data-viewer.png" alt="RStudio viewer" title="RStudio viewer" width="100%">
</figure>
]
...
.pull-left[
<figure>
  <img src="img/02a/rstudio-help.png" alt="RStudio help pane" title="RStudio help pane" width="100%">
</figure>
]
...
.box-5[Add a chunk that uses `seq()` to create a<br>list of numbers from 3 to 45, spaced by 1.5<br>.small[(so 3, 4.5, 6, 7.5, …)]]
...
.center[
<figure>
  <img src="img/02a/rstudio-cheatsheet.png" alt="RStudio cheatsheet" title="RStudio cheatsheet" width="40%">
</figure>
]


```{r echo=FALSE, include=FALSE, eval=FALSE}
pagedown::chrome_print(here::here("slides", "02a_getting-started.html"), 
                       output = here::here("slides", "02a_getting-started.pdf"))
```
